<form method="POST" action="/admin/settings" id="settings-form">
    ...
    <div class="space-y-4">
        ...
        <?php foreach ($currentCategory as $setting): ?>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start p-4 bg-gray-50/80 rounded-2xl border border-gray-200 hover:border-red-300 transition-all duration-200 hover:shadow-md">
                <div>
